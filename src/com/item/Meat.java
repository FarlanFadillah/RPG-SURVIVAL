...
public class Meat extends Item{
	public int size = 128;
    protected SpriteSheet ss = new SpriteSheet("/assets/items/meat/M_Spawn.png");
    protected SpriteSheet ss2 = new SpriteSheet("/assets/items/meat/M_Idle.png");
    ImageManager im = new ImageManager();
	public Meat(int x, int y, ID id, ItemType it) {
		super(x, y, id, it);
		// TODO Auto-generated constructor stub
		icon = ss2.grabImageXY(36, 40, 64, 64);
        name = "Meat";
        image = ss2.image;
        getImage();
	}
