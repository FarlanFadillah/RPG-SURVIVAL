		...
		if(attack1 == false && attack2 == false && cutTree == false) {
			if(isUp() || isDown()|| isRight() || isLeft()) {
				...
				case "kanan":
					...
					if(spriteAttack1 ==7) {
						image = attack1Right[6];
					}
					if(spriteAttack1 ==8) {
						image = attack1Right[7];
					}
				...
				case "ataskanan":
					if(spriteAttack1 == 1) {
						image = attack1UpRight[0];
					}
					if(spriteAttack1 == 2) {
						image = attack1UpRight[1];
					}
					if(spriteAttack1 == 3) {
						image = attack1UpRight[2];
					}
					if(spriteAttack1 ==4) {
						image = attack1UpRight[3];
					}
					if(spriteAttack1 ==5) {
						image = attack1UpRight[4];
					}
					if(spriteAttack1 ==6) {
						image = attack1UpRight[5];
					}
					if(spriteAttack1 ==7) {
						image = attack1UpRight[6];
					}
					if(spriteAttack1 ==8) {
						image = attack1UpRight[7];
					}
				...
				case "ataskiri":
					if(spriteAttack1 == 1) {
						image = attack1UpLeft[0];
					}
					if(spriteAttack1 == 2) {
						image = attack1UpLeft[1];
					}
					if(spriteAttack1 == 3) {
						image = attack1UpLeft[2];
					}
					if(spriteAttack1 ==4) {
						image = attack1UpLeft[3];
					}
					if(spriteAttack1 ==5) {
						image = attack1UpLeft[4];
					}
					if(spriteAttack1 ==6) {
						image = attack1UpLeft[5];
					}
					if(spriteAttack1 ==7) {
						image = attack1UpLeft[6];
					}
					if(spriteAttack1 ==8) {
						image = attack1UpLeft[7];
					}
				...
				case "bawahkanan":
					if(spriteAttack1 == 1) {
						image = attack1DownRight[0];
					}
					if(spriteAttack1 == 2) {
						image = attack1DownRight[1];
					}
					if(spriteAttack1 == 3) {
						image = attack1DownRight[2];
					}
					if(spriteAttack1 ==4) {
						image = attack1DownRight[3];
					}
					if(spriteAttack1 ==5) {
						image = attack1DownRight[4];
					}
					if(spriteAttack1 ==6) {
						image = attack1DownRight[5];
					}
					if(spriteAttack1 ==7) {
						image = attack1DownRight[6];
					}
					if(spriteAttack1 ==8) {
						image = attack1DownRight[7];
					}
				...
				case "bawahkiri":
					if(spriteAttack1 == 1) {
						image = attack1DownLeft[0];
					}
					if(spriteAttack1 == 2) {
						image = attack1DownLeft[1];
					}
					if(spriteAttack1 == 3) {
						image = attack1DownLeft[2];
					}
					if(spriteAttack1 ==4) {
						image = attack1DownLeft[3];
					}
					if(spriteAttack1 ==5) {
						image = attack1DownLeft[4];
					}
					if(spriteAttack1 ==6) {
						image = attack1DownLeft[5];
					}
					if(spriteAttack1 ==7) {
						image = attack1DownLeft[6];
					}
					if(spriteAttack1 ==8) {
						image = attack1DownLeft[7];
					}
